...
//Vapid public key.
var applicationServerPublicKey = 'BJMCdnqsQsHqHgzf8JTEuQe854IbRBc-9HjXOrf8qCSvKcX4MvCoANRLpgm4Mtl73Nn7si4mp10Lpq2ftfK9jBw';
    ...
    navigator.serviceWorker.ready.then(function (reg) {
        ...
        reg.pushManager.subscribe(subscribeParams)
            .then(function (subscription) {
                ...
                sendSubscriptionToServer(endpoint, key, auth,user[1]);
                isSubscribed = true;
                makeButtonUnsubscribable();
            })
            .catch(function (e) {
...
function sendSubscriptionToServer(endpoint, key, auth,user) {
    ...
    $.ajax({
        type: 'POST',
        url: url,
        data: {publicKey: encodedKey, auth: encodedAuth, notificationEndPoint: endpoint,user:userName[1]},
