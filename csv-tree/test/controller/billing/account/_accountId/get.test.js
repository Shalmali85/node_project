...
const billing = require('../../../../../src/controller/old/invoice/getBillingAccountDetails');
...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    getApi = proxyquire('../../../../../src/controller/billing/account/_accountId/get', {
      '../../../old/invoice/getBillingAccountDetails': billingStub,
