...
const accounts = require('../../../../../../src/controller/old/invoice/getAccountInvoices');
...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    getApi = proxyquire('../../../../../../src/controller/billing/account/_accountId/invoices/get', {
      '../../../../old/invoice/getAccountInvoices': accountStub,
