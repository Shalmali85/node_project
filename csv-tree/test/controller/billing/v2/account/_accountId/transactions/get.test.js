...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    getApi = proxyquire('../../../../../../../src/controller/billing/v2/account/_accountId/transactions/get', {
  ...
  it('success', async () => {
    ...
    getAccountTransactionsStub.resolves(data.transactions);
    getApi.init(config);
  ...
  it('account transcations returns error', async () => {
    const request = Object.assign(requestStub, { args: { accountId: '7000965228', bds_token: 'lSwIPGzurEtxvAKhjqjN4L' } });
  ...
  it('account transcations returns error for unexpected scenario', async () => {
    getApi.init(config);
