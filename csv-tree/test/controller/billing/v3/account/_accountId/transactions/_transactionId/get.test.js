...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    getApi = proxyquire('../../../../../../../../src/controller/billing/v3/account/_accountId/transactions/_transactionId/get', {
  ...
  it('account for a transcation  returns error', async () => {
    const request = Object.assign(requestStub, { args: { accountId: '7000965228', bds_token: 'lSwIPGzurEtxvAKhjqjN4L' } });
  ...
  it('account for a transcation returns error for unexpected scenario', async () => {
    getApi.init(config);
