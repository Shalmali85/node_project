...
const billing = require('../../../../../../src/controller/invoice/getBillingAccountDetails');
...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    getApi = proxyquire('../../../../../../src/controller/billing/v3/account/_accountId/get', {
      '../../../../invoice/getBillingAccountDetails': billingStub,
