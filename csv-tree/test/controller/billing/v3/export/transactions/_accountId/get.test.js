...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    header = sandbox.spy();
    requestStub = {};
    getApi = proxyquire('../../../../../../../src/controller/billing/v3/export/transactions/_accountId/get', {
...
describe('get', () => {
  ...
  it('account export transactions returns error', async () => {
  ...
  it('account export transactions returns error for unexpected scenario', async () => {
    getApi.init(config);
