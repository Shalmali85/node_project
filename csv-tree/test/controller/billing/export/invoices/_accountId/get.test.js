...
const exportAccounts = require('../../../../../../src/controller/old/invoice/exportAccounts');
...
describe('get', () => {
  ...
  beforeEach(() => {
    ...
    header = sandbox.spy();
    requestStub = {};
    getApi = proxyquire('../../../../../../src/controller/billing/export/invoices/_accountId/get', {
      '../../../../old/invoice/exportAccounts': exportAccountsStub,
