...
const testData = require('../../shared/accountstestdata.json');
...
describe('get Billing Data', () => {
  const getAccountsData = proxyquire('../../../../src/controller/old/shared/getBillingData.js', {});
