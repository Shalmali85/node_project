...
const getAccountInvoices = require('../../../src/controller/invoice/getAccountInvoices');
        ...
        [
          {
            ...
            invoiceIssueDate: '2018-06-01T00:00:00+00:00',
            newCharges: 440,
...
describe('get csv for billing account', () => {
  ...
  beforeEach(() => {
    ...
    exportAccounts = proxyquire('../../../src/controller/invoice/exportAccounts.js', {
